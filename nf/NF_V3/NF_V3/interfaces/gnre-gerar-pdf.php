...
use Dompdf\Dompdf;
#$args = (isset($argv[1]) ? $argv[1]: false    );
#var_dump($argv);
...
if (isset($argv[1])){
    #print(">>>>>>>>>>>>>>>>>>>>>>>>>>>\n".$argv[1]);
    var_dump(unserialize($argv[1]));
}


#gerar_gnre_pdf();

#function gerar_gnre_pdf($args = "") {
    ...
    file_put_contents("testeFInal.pdf",$pdf->create($html)->output( array('Attachment' => 1)));
