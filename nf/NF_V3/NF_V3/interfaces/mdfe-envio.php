...
/* /user/mdfe/82574062000252/CaixaEntrada/Processar/MDFE-000000033-000-20170727-144941.TXT*/
    ...
    */
    ...
    function validaXml($arquivo_xml,$cnpj,$config,$ws)
    {
        ...
        $xsd = $config['servicos']."/mdfe/schemas/PL_MDFe_300a/{$ws->schema}";
        #$xsd = $config['servicos']."/mdfe/schemas/PL_MDFe_300a/{$ws->schema}";
    ...
    #echo formatXML($template_soap, "retorno");exit();
    ...
    //var_dump($dados['mdfe']['dir_saida_cobol'].$nome_arquivo_saida);exit();
 ?>
