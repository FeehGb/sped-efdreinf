<?php 
     ...
     *      php /var/www/html/nf/NF_V3/NF_V3/interfaces/nfe-status.php 72071541000545 debug 1 PR
    */ 
    ...
    //print(">>>>>>>>>>>>>>>>>>");
    //print($config['dados']."config_cliente/".$cnpj.".ini");
    //print(">>>>>>>>>>>>>>>>>>");
    ...
    $r = exec("php ../ferramentas/cria_pem.php ".$dados['certificado']['arquivo_certificado']." ".$dados['certificado']['senha']);
    #print($r);exit();
