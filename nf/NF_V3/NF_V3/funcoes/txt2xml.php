<?php
    ...
    class class_txt2xml
    {
        ...
        function converter()
        {
            ...
            $xml = file_get_contents($pathSaidaXML);
            //! ADICIONADO PARA QUE O NO CASO DO QRCODE TENHA UM ROOT PARA CONVERSAO!
            $xml = "<rootRemove>$xml</rootRemove>";
        ...
        function salvar()
        {
            ...
            $xml  = preg_replace("/<\/?rootRemove>/",'',$xml) ; 
            // fecha o escopo
            $xml .= $this->escopoFim ; 
    ...
    class class_txt2xml_NOTAFISCAL extends class_txt2xml
    {
        function __construct(){
            ...
            $this->sempreRepetir   = array('Y', 'Z', 'I80') ;
        ...
        function montaChaveXML($dom)
        {
            ...
            $cnpj           = $emit ->getElementsByTagName('CNPJ'   )->item(0)->nodeValue ; 
            $cpf            = $emit ->getElementsByTagName('CPF'   )->item(0)->nodeValue ;
            if($cpf) $cnpj  = '000'.$cpf;
            $mod            = $ide  ->getElementsByTagName('mod'    )->item(0)->nodeValue ; 
            $serie          = $ide  ->getElementsByTagName('serie'  )->item(0)->nodeValue ; 
    ...
    class class_txt2xml_REINF extends class_txt2xml
    {
        ...
        function __construct(){
            ...
            $this->sempreRepetir   = array("B", "C", "D", "H", "J", "O", "P" ) ;
