...
class class_txt2xml:
    ...
    def processLinha(self, linha, dadosLinhaTxt):
        ...
        elif len(linhaSimplificada) == 1 or linha[0] in self.arSempreRepetir or (len(linhaSimplificada) > 1  and linha in self.arSempreRepetir) :  #linha[0] in self.arSempreRepetir :#linha in self.arSempreRepetir :  #
            # prepara o xml para a repeticao
            #print(linhaSimplificada)
