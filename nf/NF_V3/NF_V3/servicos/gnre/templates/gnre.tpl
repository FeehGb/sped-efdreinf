<html>
    ...
    <body>
        {foreach $guiaViaInfo as $key => $via}
            <table cellspacing="0" cellpadding="1" style="width:99%;">
                <tr>
                        ...
                        <table cellspacing="0" cellpadding="1" style="width:100%">
                            ...
                            <tr>
                                <td class="nobrdtb" colspan="2" style="height:64px" valign="top">
                                    Informações Complementares:<br /> {$guia->retornoInformacoesComplementares}
                                </td>
                            </tr>
                            <tr>
                                <td class="notop" colspan="2">
                    ...
                    <td  class="noborder" valign="top">
                        <table cellspacing="0" cellpadding="1" style="width:100%; margin-left: -1px;">
                            ...
                            <tr>
                                ...
                                class="notop"
                                {if  strlen($guia->c04_docOrigem) > 7 }
                                    style="
                                        font-size: 8px;
                                        font-weight:bold"  
                                {/if}
                                >
                                {$guia->c04_docOrigem}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" class="notop" align="right"> {$guia->retornoAtualizacaoMonetaria}</td>
                            </tr>
                            <tr>
                                <td colspan="3" class="nobottom">Juros</td>
                            </tr>
                            <tr>
                                <td colspan="3" class="notop" align="right"> {$guia->retornoJuros}</td>
                            </tr>
                            <tr>
                                <td colspan="3" class="nobottom">Multa</td>
                            </tr>
                            <tr>
                                <td colspan="3" class="notop" align="right"> {$guia->retornoMulta}</td>
                            </tr>
                            <tr>
