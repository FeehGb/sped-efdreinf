...
// php -q /var/www/html/nf/NF_V3/NF_V3/interfaces/mdfe-encerramento.php /user/mdfe/11352160000116/CaixaEntrada/Processar/EMDFE-000000003-000-20190131-153343.txt
// php -q /var/www/html/nf/NF_V3/NF_V3/interfaces/mdfe-encerramento.php /user/mdfe/11352160000116/CaixaEntrada/Processar/EMDFE-000000003-000-20190131-155806.txt
// status 630
    ...
    /*
        ...
        Modo de uso: 
        	php /var/www/html/nf/NF_V3/NF_V3/interfaces/mdfe-encerramento.php <caminho_arquivo.txt>

        Template do arquivo:
        cnpj|uf autorizador|uf_ws|ambiente|chave mdfe|num protocolo|tipo evento|data/hora encerramento|uf encer.|municipio encer
    ...
    */
    ...
    require_once("../funcoes/mdfeEncerramento2array.php"); // Usado para converter o txt em xml
    ...
    $arquivo_saida = str_replace("EMDFE","EMDFER",$nome_raiz).".txt";
    ...
    $array_dados = mdfeEncerramento2array($arquivo_txt,$arquivo_xml);
    ...
    $array_webservice = $dados_ws->buscarServico("encerramento",$dados['mdfe']['versao']);
    ...
    $array_substituicao= array(
        ...
        'ALTERAR_DATA_ENCERRAMENTO'=>$array_dados['data_encerramento'],
        'ALTERAR_TIPO_EVENTO'=>$array_dados['tipo_evento'],
        'ALTERAR_NRO_PROTOCOLO'=>$array_dados['protocolo'],
        'ALTERAR_UF_ENCERRAMENTO'=>$array_dados['uf_encerramento'],
        'ALTERAR_MUNICIPIO_ENCERRAMENTO'=>$array_dados['municipio_encerramento'],
    ...
    // echo $template_soap ; exit() ; 
    
    // echo $dados['mdfe']['dir_saida_cobol'] . $arquivo_saida ; 
    ...
    $retorno[] = $uf_ws;
    $retorno[] = $xml_retorno; //  Conversado com o roberto e ele nos indicou a deixar o xml de retorno no fim do arquivo [18/07/2017]
