<?php
    /*
        Programa:  nfe-append_cancelamento.php
        Descricão: Programa responsavel por fazer o append do cancelamento
        O programa faz a juncao de duas partes de xml para realizar a criacao do arquivo de retorno.
        As duas partes estao dentro do NF_V3_dados/temp/nfe, gravados pelo nfe-cancelamento.php
        Autor:     Fernando H. Crozetta (27/02/2018)
        Modo de uso:
            php /var/www/html/nf/NF_V3/NF_V3/interfaces/nfe-append-cancelamento.php <cnpj> <arquivoSaida> <nota> <ambiente> <uf> <autorizador>
    */
    ...
    $parte1 = file_get_contents($temp."/".$chave.".cancelamento_parte1.xml");
    $parte2 = file_get_contents($temp."/".$chave.".cancelamento_parte2.xml");
