...
/**
    ...
    Data: 21/07/2017
    Funcção: Converter arquivo txt de cancelamento para array
*/

function mdfeCancelamento2array($arquivo_txt,$arquivo_xml)
{
    // Mapeia os dados do txt de acordo com o array de nomes abaixo:
    $nomes_array = array ("cnpj","uf_contribuinte","uf_ws","ambiente","chave","protocolo","tipo_evento","data_hora","justificativa");
    $dados = array();
