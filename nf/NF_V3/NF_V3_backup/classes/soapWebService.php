<?php 
    ...
    require_once ("../funcoes/httpStatus.php"); // Carrega as configuracoes
    /**
    ...
    class SoapWebService
    {
        ...
        function custonHeader()
        {
            ...
            switch($this->autorizadora)
            {
                ...
                case "MG" : 
                    // print(">>>>>>>>>>>>>>>HEADER MG \n ");
                    $curl_header = Array(
                        "Content-Type: application/soap+xml;charset=UTF-8;action=\"http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento/cteRecepcaoEvento\"",
                        "Content-length: $tamanho",
                        "Pragma: no-cache",
                ...
                case "SP":
                    ...
                    $curl_header = Array(
                        ...
                        // "Content-Type: application/soap+xml;charset=utf-8;action=\"$metodo\"",
        ...
        */
        public function comunicar($debug=false)
        {
            ...
            // print_r($this->array_dados_cliente);
            ...
            $n = strlen($__xml);
            $x = stripos($__xml, "<");
            $this->xmlRetorno = htmlspecialchars_decode(substr($__xml, $x, $n-$x));
            curl_close($curl);
            // return $__xml;
        ...
        function curl_getinfo($info){
            if ($this->_curl_getinfo !== false){
                return $this->_curl_getinfo[$info];
            }else {
                return false;
            }
        }
