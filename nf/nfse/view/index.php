...
<!---------------->
  <form name="formPortal" id="formPortal" action="">
   ...
   <b>Contribuinte: </b>
   <select id="sContribuinte" name="sContribuinte" style="width:600px; font-size:12px; font-style:oblique;">
   </select><br/><br/>
...
<tr>
  ...
  Atualizar
    ...
    <td>
    <div align="right">
    <a href="" class="ui-widget-header" style="cursor:pointer" title="Clique aqui para fazer Backup" name="aBackup" id="aBackup">Clique aqui para fazer Backup </a>
    </div>
    </td>
</tr>
</table>
