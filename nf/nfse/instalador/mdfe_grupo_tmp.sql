...
--
-- Estrutura para Criar Base de Dados mdfe_barao para cada cliente e suas tabelas
--
...
--
-- Banco de Dados: `mdfe_barao`
--

CREATE DATABASE IF NOT EXISTS mdfe_barao;
...
CREATE TABLE IF NOT EXISTS `mdfe_barao`.`CONTRIBUINTE` (
...
CREATE TABLE IF NOT EXISTS `mdfe_barao`.`CRITICA` (
...
CREATE TABLE IF NOT EXISTS `mdfe_barao`.`EVENTO` (
  `cnpj` varchar(14) NOT NULL COMMENT 'CNPJ (tabela MDFE)',
  `ambiente` varchar(1) NOT NULL COMMENT 'Ambiente (tabela MDFE)',
...
CREATE TABLE IF NOT EXISTS `mdfe_barao`.`LOG` (
  `cnpj` varchar(14) NOT NULL COMMENT 'CNPJ (tabela MDFE)',
  `ambiente` varchar(1) NOT NULL COMMENT 'Ambiente (tabela MDFE)',
  `numero` varchar(9) NOT NULL COMMENT 'Número da MDFe (tabela MDFE)',
  `serie` varchar(3) NOT NULL COMMENT 'Série da MDFe (tabela MDFE)',
...
--
CREATE TABLE IF NOT EXISTS `mdfe_barao`.`LOTE` (
...
CREATE TABLE IF NOT EXISTS `mdfe_barao`.`MDFE` (
  `cnpj` varchar(14) NOT NULL COMMENT 'CNPJ (tabela CONTRIBUINTE)',
  `ambiente` varchar(1) NOT NULL COMMENT 'Ambiente (tabela CONTRIBUINTE)',
