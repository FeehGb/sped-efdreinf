...
--
-- Estrutura para Criar Base de Dados nfse_barao para cada cliente e suas tabelas
--
...
--
-- Banco de Dados: `nfse_barao`
--

CREATE DATABASE IF NOT EXISTS nfse_barao;
...
CREATE TABLE IF NOT EXISTS `nfse_barao`.`backup` (
...
CREATE TABLE IF NOT EXISTS `nfse_barao`.`critica` (
...
CREATE TABLE IF NOT EXISTS `nfse_barao`.`empresa` (
...
CREATE TABLE IF NOT EXISTS `nfse_barao`.`generico` (
  `cnpj` varchar(14) NOT NULL COMMENT 'CNPJ do contribuinte responsável pela Nota',
...
CREATE TABLE IF NOT EXISTS `nfse_barao`.`item` (
  `cnpj` varchar(14) NOT NULL COMMENT 'CNPJ do contribuinte responsável pela Nota',
...
CREATE TABLE IF NOT EXISTS `nfse_barao`.`lote` (
...
CREATE TABLE IF NOT EXISTS `nfse_barao`.`nota_fiscal` (
