...
--
-- Estrutura para Criar Base de Dados nfe_<grupo> para cada cliente e suas tabelas
--
...
--
-- Banco de Dados: `nfe_<grupo>`
--

CREATE DATABASE IF NOT EXISTS nfe_<grupo>;
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`CONTRIBUINTE` (
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`CRITICA` (
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`EVENTO` (
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`INUTILIZACAO` (
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`LOG` (
  `NOTA_FISCAL_cnpj_emitente` varchar(14) NOT NULL,
  `NOTA_FISCAL_numero_nota` varchar(9) NOT NULL,
  `NOTA_FISCAL_serie_nota` varchar(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`LOTE` (
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`NOTA_FISCAL` (
  `cnpj_emitente` varchar(14) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`WEB_SERVICE` (
...
--
CREATE TABLE IF NOT EXISTS `nfe_<grupo>`.`NF_DESTINADAS` (
