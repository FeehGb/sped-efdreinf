  ...
  <table border="0">
    ...
    <div class="corpo ui-widget-content" style="margin-left:30px;">
        ...
        <tr>
          ...
          <td width="180"><input type="text" name="ws_codigoTom" id="ws_codigoTom" size="30" readonly="readonly" value="78859" /></td>
	  ...
	  <td class="exemplo">Servidor Homologa&ccedil;&atilde;o: https://homologacao.ginfes.com.br/ServiceGinfesImpl?wsdl<br><br>
			Servidor Produ&ccedil;&atilde;o: https://producao.ginfes.com.br/ServiceGinfesImpl?wsdl</td>
        </tr>
        <tr>
          <td>Porta</td>
...
var flagUtilizarBD=0;
	$(function() {
	  ...
	  $('#ws_arquivo').change(function(){
		  ...
		  document.getElementById("formConfigWS").action = "SaoJoseDosPinhais-PR.php";
		  $('#formConfigWS').submit();
		  return false;
	  });
