  ...
  <table border="0">
    ...
    <div class="corpo ui-widget-content" style="margin-left:30px;">
        ...
        <tr>
          ...
          <td width="180"><input type="text" name="ws_codigoTom" id="ws_codigoTom" size="30" readonly="readonly" value="75639" /></td>
          <td width="301" class="exemplo">C&oacute;digo da Cidade no cadastro da Receita Federal
          </td></tr>
        <tr>
          <td>URL Servidor</td>
          <td colspan="2"><input type="text" name="ws_url" id="ws_url" size="100" value="http://homologa.nfse.pmfi.pr.gov.br/nfsews/nfse.asmx?wsdl"/></td>
        </tr>
        <tr>
          <td>Porta</td>
          <td><input type="text" name="ws_porta" id="ws_porta" size="10" value="<?php echo $_POST['ws_porta'];?>"/></td>
...
var flagUtilizarBD=0;
	$(function() {
	  ...
	  $('#ws_arquivo').change(function(){
		  ...
		  document.getElementById("formConfigWS").action = "FozDoIguacu-PR.php";
		  $('#formConfigWS').submit();
		  return false;
	  });
