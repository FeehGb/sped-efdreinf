	...
	class CFozDoIguacu{
		...
		public function enviarRPS($pEmpesa, $pFilial, $pNumeroControle){
			...
			*/
			...
			file_put_contents("/user/objetos/respostaEnviar.xml",$this->xmlRetornoWS);
			...
			file_put_contents("\user\objetos\respostaProtocolo.txt",$lixo);
		...
		private function wsRespostaFozDoIguacu(){
			...
			*/
			...
			file_put_contents("/user/objetos/retornoConsulta.xml", $this->xmlRetornoWS);
			$DDoc->loadXML($this->xmlRetornoWS);
...
//			curl_setopt($oCurl, CURLOPT_SSLVERSION, 3);
		  ...
		  if($this->ConfigWs['WSConexaoSegura'] == "S" && $assinatura == "S"){
