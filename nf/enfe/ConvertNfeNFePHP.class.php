        ...
        for ($l = 0; $l < count($arquivo); $l++) {
            ...
            switch ($dados[0]) {
                ...
                case "E":
                    ...
                    if ($this->tpAmb == '2') {
                        $xNome = $dom->createElement("xNome", 'NF-x EMITIDA EM AMBIENTE DE HOMOLOGACAO - SEM VALOR FISCAL');
                ...
                case "I":
                    ...
                    $uCom = $dom->createElement("uCom", str_pad($dados[7],3,".",STR_PAD_RIGHT));
                    ...
                    if (!empty($dados[12])) {
                        $uTrib = $dom->createElement("uTrib", str_pad($dados[12],3,".",STR_PAD_RIGHT));
                    } else {
