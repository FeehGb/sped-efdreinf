...
class UnConvertCTePHP
{
    ...
    public function __simpleGetValue( $theObj , $keyName , $extraBefore = "" , $extraTextAfter = "" , $itemNum = 0 ){
    ...
    public function ctexml2txt($arq)
    {
        ...
        for ($x = 0; $x < $nctematriz; $x++) {
            ...
            // Corrige o erro possiveis erros causados por conter pipes em algum campo 
            // $matriz[$x] = str_replace('|', ' ', $matriz[$x]);
            ...
            // if (strpos($conteudo_xml, '<cteOSProc') !== false) {
            //     $cteOSProc = $dom->getElementsByTagName("cteOSProc")->item(0);
            }// 
            ...
            if (!empty($toma03)) {
                ...
                #$toma3 = $toma3->nodeValue;
                $toma  = $this->__simpleGetValue($toma3, "toma");
                $txt  .= "TOMA3|$toma\r\n";
...
*/
            $CST     = str_replace(".", ",", $this->__simpleGetValue($ICMS, "CST") );
            $pRedBC  = str_replace(".", ",", $this->__simpleGetValue($ICMS, "pRedBC") );
            $vBC     = str_replace(".", ",", $this->__simpleGetValue($ICMS, "vBC") );
            $pICMS   = str_replace(".", ",", $this->__simpleGetValue($ICMS, "pICMS") );
            $vICMS   = str_replace(".", ",", $this->__simpleGetValue($ICMS, "vICMS") );
            $vCred   = str_replace(".", ",", $this->__simpleGetValue($ICMS, "vCred") );

            $pRedBCOutraUF = str_replace(".", ",", $this->__simpleGetValue($ICMS, "pRedBCOutraUF") );
            $vBCOutraUF    = str_replace(".", ",", $this->__simpleGetValue($ICMS, "vBCOutraUF") );
            $pICMSOutraUF  = str_replace(".", ",", $this->__simpleGetValue($ICMS, "pICMSOutraUF") );
            $vICMSOutraUF  = str_replace(".", ",", $this->__simpleGetValue($ICMS, "vICMSOutraUF") );

            //To-do...
            switch ($CST) {
                case '00':
                    $txt .= "ICMS00|$CST|".str_replace(".", ",", $vBC)."|$pICMS|".str_replace(".", ",", $vICMS)."\r\n";
                    break;
                case '20':
                    $txt .= "ICMS20|$CST|$pRedBC|".str_replace(".", ",", $vBC)."|$pICMS|".str_replace(".", ",", $vICMS)."\r\n";
                    break;
                case '40':
                case '41':
                case '51':
                    ...
                    break;
                case '60':
                    $txt .= "ICMS60|$CST|".str_replace(".", ",", $vBCSTRet)."|".str_replace(".", ",", $vICMSSTRet)."|$pICMSSTRet|".str_replace(".", ",", $vCred)."\r\n";
                    break;
                case '90':
                    if (!empty($vICMSOutraUF)){
                        $txt .= "ICMS90|$CST|$pRedBC|$vBCOutraUF|$pICMSOutraUF|$vICMSOutraUF\r\n";
                    }else {
                        $txt .= "ICMS90|$CST|$pRedBC|$vBC|$pICMS|$vICMS|$vCred\r\n";
                        
                    }
//t73526-william     $txt .= "ICMS90|$CST|$pRedBC|$vBCOutraUF|$pICMSOutraUF|$vICMSOutraUF|".str_replace(".", ",", $vCred)."\r\n";
                    #$txt .= "ICMS90|$CST|$pRedBC|$vBC|$pICMS|$vICMS|$vCred\r\n";
//t73526-roy         $txt .= "ICMS90|$CST|".str_replace(".", ",", $vBc)."|".str_replace(".", ",",$pICMS)."|".str_replace(".", ",",$vICMS)."|".str_replace(".", ",",$vICMSOutraUF)."|".str_replace(".", ",", $vCred)."\r\n";
