<?php
    ...
    */ 
    ...
    file_put_contents("/home/fernando/arquivo.txt",$conteudo_arquivo,FILE_APPEND);
	...
	switch($opcao)
    {
        ...
        case "MDFE":
            ...
            file_put_contents("/var/www/html/nf/mdfe_cobol/temp/xml.xml", $xml);
		...
		case "CMDFE":
            ...
            $retorno = $MDFeNFePHP->manifDest($chave, $tipo_evento, $ambiente, $justificativa, '2', $aRetorno, $protocolo); // Versão PHP acima de 5.3
        ...
        case "EMDFE":
            ...
            $retorno = $MDFeNFePHP->manifDest($chave, $tipo_evento, $ambiente, $cidade_encerramento, '2', $aRetorno, $protocolo); // Versão PHP acima de 5.3
