    ...
    protected function nfeTxt2XmlArrayComLinhas($arrayComAsLinhasDoArquivo)
    {
        ...
        for ($l = 0; $l < count($arquivo); $l++) {
            ...
            switch ($dados[0]) {
                ...
                case "I":
                    ...
                    if (!empty($dados[24])) { // Alteração nota tecnica 2015.003 ICMS interestadual
                ...
                case "NA01": // NT 2015.003 - ICMS Interestadual
                    ...
                    $vBCUFDest = ltrim($dados[1],"0");
                    if($vBCUFDest != ""){
                        $vBCUFDest = $dom->createElement("vBCUFDest", $vBCUFDest);
                        $ICMSUFDest->appendChild($vBCUFDest);
                        $auxZerado++;
                    }
                    
                    $pFCPUFDest = ltrim($dados[2],"0");
                    if($pFCPUFDest != ""){
                        $pFCPUFDest  = $dom->createElement("pFCPUFDest", $pFCPUFDest);
                        $ICMSUFDest->appendChild($pFCPUFDest);
                        $auxZerado++;
                    }
                        
                    $pICMSUFDest = ltrim($dados[3],"0");
                    if($pICMSUFDest != ""){
                        $pICMSUFDest = $dom->createElement("pICMSUFDest", $pICMSUFDest);
                        $ICMSUFDest->appendChild($pICMSUFDest);
                        $auxZerado++;
                    }
                        
                    $pICMSInter = ltrim($dados[4],"0");
                    if($pICMSInter != ""){
                        $pICMSInter = $dom->createElement("pICMSInter", $pICMSInter);
                        $ICMSUFDest->appendChild($pICMSInter);
                        $auxZerado++;
                    }
                    
                    $pICMSInterPart = ltrim($dados[5],"0");
                    if($pICMSInterPart != ""){
                        $pICMSInterPart = $dom->createElement("pICMSInterPart", $pICMSInterPart);
                        $ICMSUFDest->appendChild($pICMSInterPart);
                        $auxZerado++;
                    }
                    
                    $vFCPUFDest = ltrim($dados[6],"0");
                    if($vFCPUFDest != ""){
                        $vFCPUFDest = $dom->createElement("vFCPUFDest", $vFCPUFDest);
                        $ICMSUFDest->appendChild($vFCPUFDest);
                        $auxZerado++;
                    }
                    
                    $vICMSUFDest = ltrim($dados[7],"0");
                    if($vICMSUFDest != ""){
                        $vICMSUFDest  = $dom->createElement("vICMSUFDest", $vICMSUFDest);
                        $ICMSUFDest->appendChild($vICMSUFDest);
                    }
                    
                    $vICMSUFRemet = ltrim($dados[8],"0");
                    if($vICMSUFRemet != ""){
                        $vICMSUFRemet = $dom->createElement("vICMSUFRemet", $vICMSUFRemet);
		...
		case "YA04":
					if(!empty($dados[1])){
                      ...
                      $tBand = $dom->createElement("tBand",$dados[2]);
                      $card->appendChild($tBand);
                      $cAut = $dom->createElement("cAut",$dados[3]);
