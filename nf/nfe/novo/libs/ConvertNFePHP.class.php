        ...
        for ($l = 0; $l < count($arquivo); $l++) {
            ...
            switch ($dados[0]) {
                ...
                case "B": //identificadores [infNFe]
					...
					// Obtem a contingencia atraves do cadastro do contribuinte gjps
					if(isset($this->arrayContribuinte['contigencia'])){
						$tpEmis = $dom->createElement("tpEmis", ltrim($this->arrayContribuinte['contigencia'],0));
					}else{
