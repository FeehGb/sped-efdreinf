...
<!---------------->
  <form name="formPortal" id="formPortal" action="">
        ...
        <input type="hidden" id="hNomeBackup" name="hNomeBackup" />
  </form>
   <div style="margin:0; padding:5px; padding-left:15px; padding-right:15px;">
   <br/><br/>
	  <div id="toolbar"><b>Ordenar</b>
		<span id="set">
		  <button title="Autorizadas"><img height="12" src="../imagens/asterisk_orange.png"></button>
		  &nbsp;<button title="Canceladas"><img height="12" src="../imagens/cross.png"></button>
		  &nbsp;<button title="Rejeitada"><img height="12" src="../imagens/exclamation.png"></button>
		  &nbsp;<button title="Denegada"><img height="12" src="../imagens/error.png"></button>
		  &nbsp;<button title="Inutilizada"><img height="12" src="../imagens/arrow_down.png"></button>
		</span>
		  <button><img height="12" src="../imagens/lightning.png"> Personalizar Busca</button>
		  <button><img height="12" src="../imagens/lightning_delete.png"> Remover Busca</button>
	  </div>
	  <br/><br/>
...
<br>
  <div style="float:left">
	  <button id="bAtualizar" name="bAtualizar">
		<img id="imgLimpar" src="../imagens/arrow_refresh.png" alt="Limpar Pesquisa" title="Limpar Pesquisa"/> Atualizar
	  </button>
  </div>
  <div style="float:right">
	  <button><img height="12" src="../imagens/cross.png"> Cancelar</button>
	  <button><img height="12" src="../imagens/arrow_down.png"> Inutilizar</button>
	  <button><img height="12" src="../imagens/arrow_refresh.png" title="Limpar Pesquisa"/> Visualizar </button>
	  <button><img height="12" src="../imagens/arrow_refresh.png" title="Limpar Pesquisa"/> DANFE </button>
	  <button><img height="12" src="../imagens/arrow_refresh.png" title="Limpar Pesquisa"/> Detalhes </button>
...
<div id="divBackUp">
  <br />
    <table cellpadding="5">
          <tr>
          <td>Informe um nome para o Backup</td>
          <td><input type="text" name="tNomeBackup" id="tNomeBackup" size="35" maxlength="50"/></td>
          <td><div id="tDataHora" name="tDataHora"></div></td>
          <td><input type="button" name="bGerar" id="bGerar"  value="Gerar" title"Gerar"/></td>
    </table>
<br />
  <div align="center">
    <table cellpadding="5" width="100%">
      <tr class="ui-widget-header">
          <td width="33%">Nome Do Backup</td>
          <td width="33%">Data/Hora</td>
          <td width="34%">Download</td>
      </tr>
   </table>
   <div style="height:300px; width:100%; overflow:scroll">
      <table cellpadding="5" width="100%" id="tableListaBackUp">
      </table>
    </div>
  </div>
</div>
