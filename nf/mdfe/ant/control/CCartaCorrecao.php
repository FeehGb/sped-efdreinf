 ...
 */
	public function mIncluirCC(){
		...
		// Enviar e-mail para o usuário informando que foi efetuada uma carta de correção.
		// TODO: fazer quando estiver com o NFE027 Pronto
 ...
 */
	...
	// Obter informações da Carta de Correção
		...
		file_put_contents("/var/www/html/guilherme/saida2.xml",base64_decode($fieldsNF[0]['xml']));
	...
	// Montar dados do JUGIRXML
		...
		if(trim($retorno[0]['danfe_logo_caminho']) != ""){
			$arrayIRXML['detail'][$seq]['record']['logomarca'] = trim($fieldsContribuinte['danfe_logo_caminho']);
		}else{
	...
	// Dados do Destinatário
		...
		$arrayIRXML['detail'][$seq]['record']['dest-IE']		= $enderDest->getElementsByTagName("IE")->item(0)->nodeValue;
